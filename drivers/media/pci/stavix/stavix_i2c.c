...
static void xiic_reinit(struct stavix_i2c *i2c)
{
	...
	pci_write(STAVIX_I2C_BASE,STAVIX_TSUSTA_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_TSUSTO_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_THDSTA_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_TSUDAT_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_TBUF_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_THIGH_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_TLOW_REG_OFFSET,400);//400
	
	pci_write(STAVIX_I2C_BASE,STAVIX_THDAT_REG_OFFSET,400);//400
}
